...
前後の文脈・会議全体のサマリー・話者の役割を根拠に、意味が合わない表記を正しい漢字に修正する。

確認が必要な代表的パターン:
- 「以外」/「意外」: 除外の文脈か、驚きの文脈か
- 「取る」/「採る」: 人材採用・採集の文脈では「採る」（「人を採っていく」「候補者を採る」等）
- 「対応」/「対抗」/「体制」: 場面によって混同しやすい
- 「制作」/「製作」/「政策」/「成果」: 業務文脈で頻出
- 「確認」/「革新」、「運営」/「運用」: 組織・業務文脈で混同
- 「機会」/「機械」/「規格」: 読みが近い業務用語
- 「効果」/「高価」/「考課」: 評価・コスト文脈で混同
- 「関心」/「感心」/「歓心」: 感情・興味の文脈
- 「対象」/「対称」/「対照」: 比較・分析文脈
- 「課題」/「家題」/「過大」、「支援」/「試案」: プロジェクト・支援文脈
- その他、文中で意味的に不自然な漢字表記があれば積極的に修正する

修正の根拠は必ず「前後の文意」「話者の役職・会社・プロジェクト文脈」に基づくこと。
