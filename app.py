_NOTO_LOGO_B64 = ""
...
def _trim_filename(name: str, limit: int = 22) -> str:
    """Shorten long filenames to fit the card, keeping the extension visible."""
    if len(name) <= limit:
        return name
    p = Path(name)
    sfx = p.suffix
...
_COPY_ICON_N=""
_COPY_ICON_G=""
_PENCIL_ICON_N=""
_PENCIL_ICON_G=""
# ─── Copy button (clipboard icon) ─────────────────────────────────────────────

class CopyButton(tk.Canvas):
    """Icon-only button that draws a line-style clipboard."""
    _W, _H = 34, 30

    def __init__(self, master, command=None, bg=_BG_RIGHT, **kwargs):
        ...
        self._img_n=tk.PhotoImage(data=_COPY_ICON_N)
        self._img_g=tk.PhotoImage(data=_COPY_ICON_G)
        self._draw()
        self.bind("<Button-1>", self._click)
        self.bind("<Enter>", self._on_enter)
        self.bind("<Leave>", self._on_leave)

    def _draw_rrect(self, x1, y1, x2, y2, r, fill, outline):
        ...
        for ox, oy in [(x1, y1), (x2 - 2*r, y1), (x1, y2 - 2*r), (x2 - 2*r, y2 - 2*r)]:
            self.create_oval(ox, oy, ox + 2*r, oy + 2*r, fill=fill, outline=fill)
        self.create_arc(x1, y1, x1+2*r, y1+2*r, start=90,  extent=90, outline=outline, style="arc")
        self.create_arc(x2-2*r, y1, x2, y1+2*r, start=0,   extent=90, outline=outline, style="arc")
        self.create_arc(x1, y2-2*r, x1+2*r, y2, start=180, extent=90, outline=outline, style="arc")
        self.create_arc(x2-2*r, y2-2*r, x2, y2, start=270, extent=90, outline=outline, style="arc")
    ...
    def _draw_rrect_outline(self, x1, y1, x2, y2, r, col, lw=1.5):
        self.create_arc(x1, y1, x1+2*r, y1+2*r, start=90,  extent=90, outline=col, style="arc", width=lw)
        self.create_arc(x2-2*r, y1, x2, y1+2*r, start=0,   extent=90, outline=col, style="arc", width=lw)
        self.create_arc(x1, y2-2*r, x1+2*r, y2, start=180, extent=90, outline=col, style="arc", width=lw)
        self.create_arc(x2-2*r, y2-2*r, x2, y2, start=270, extent=90, outline=col, style="arc", width=lw)
        self.create_line(x1+r, y1, x2-r, y1, fill=col, width=lw)
        self.create_line(x1+r, y2, x2-r, y2, fill=col, width=lw)
        self.create_line(x1, y1+r, x1, y2-r, fill=col, width=lw)
        self.create_line(x2, y1+r, x2, y2-r, fill=col, width=lw)

    def _draw(self):
        self.delete("all")
        bg = _BG_CARD if (self._hover and self._enabled) else "#FFFFFF"
    ...
    def show_check(self):
        self._checked = True
        self._draw()
        self.after(2000, self._clear_check)
...
class EditToggle(tk.Canvas):
    ...
    def __init__(self, master, command=None, bg=_BG_RIGHT, **kwargs):
        ...
        self._enabled = False
        self._command = command
        self._pencil_n=tk.PhotoImage(data=_PENCIL_ICON_N)
        self._pencil_g=tk.PhotoImage(data=_PENCIL_ICON_G)
        self._draw()
        self.bind("<Button-1>", self._click)
        self.bind("<Enter>", lambda e: self.config(cursor="hand2") if self._enabled else None)
        self.bind("<Leave>", lambda e: self.config(cursor=""))

    def _fill_pill(self, x1, y1, x2, y2, color):
        r = (y2 - y1) // 2
        self.create_rectangle(x1 + r, y1, x2 - r + 1, y2, fill=color, outline=color)
    ...
    def _draw(self):
        ...
        if not self._enabled:
            pill_col, icon_col = "#E2E8F0", "#CBD5E1"
        elif self._on:
            pill_col, icon_col = _ACCENT, _ACCENT
        else:
            pill_col, icon_col = "#CBD5E1", "#475569"
        self._fill_pill(pad, pad, w - pad, h - pad, pill_col)
        cx = (w - pad - r) if self._on else (pad + r)
        cy = h // 2
        cr = r - 2
        self.create_oval(cx - cr, cy - cr, cx + cr, cy + cr, fill="#FFFFFF", outline="")
        img=self._pencil_n if self._enabled else self._pencil_g
        self.create_image(cx, cy, image=img)
...
class DropZone(ctk.CTkFrame):
    ...
    def __init__(self, master, on_file: callable, on_clear: callable = None, **kwargs):
    ...
    def _build_empty(self):
        ...
        _make_upload_icon(self, size=52).pack(pady=(18, 4))
        ...
        if _HAS_DND:
            ctk.CTkLabel(self, text="または",
                         font=ctk.CTkFont(size=11), text_color=_TEXT_MUTED).pack(pady=1)
        ...
        ctk.CTkLabel(
            self,
            text="対応形式: MP3, MP4, WAV, M4A, MOV など",
        ...
        if _HAS_DND:
            ...
            self.dnd_bind("<<DragEnter>>", lambda _e: self.configure(border_width=2, border_color=_ACCENT))
            self.dnd_bind("<<DragLeave>>", lambda _e: self.configure(border_width=1, border_color=_BORDER))
    ...
    def _build_file_card(self, path: str):
        ...
        # Icon
        icon_bg = ctk.CTkFrame(row, fg_color="#DBEAFE", corner_radius=6, width=40, height=40)
        icon_bg.grid(row=0, column=0, padx=(10, 8), pady=8)
        icon_bg.grid_propagate(False)
        ctk.CTkLabel(icon_bg, text="🎵", font=ctk.CTkFont(size=16)).place(relx=0.5, rely=0.5, anchor="center")

        # Text
        txt = ctk.CTkFrame(row, fg_color="transparent")
        txt.grid(row=0, column=1, sticky="ew", pady=8)
        ctk.CTkLabel(
            txt, text=_trim_filename(p.name),
            font=ctk.CTkFont(size=13, weight="bold"),
            text_color=_TEXT, anchor="w",
        ).pack(anchor="w")
        ctk.CTkLabel(
            txt, text=f"{size_str}{duration_str}",
            font=ctk.CTkFont(size=10), text_color=_TEXT_MUTED, anchor="w",
        ).pack(anchor="w")

        # Clear button
        ctk.CTkButton(
            row, text="×", width=24, height=24,
            fg_color="transparent", text_color=_TEXT_MUTED,
            hover_color="#DBEAFE", corner_radius=12,
...
class App(_AppBase):  # type: ignore[misc]
    ...
    def _build_left(self):
        ...
        # Scrollable middle area (title + drop zone + settings)
        scroll = ctk.CTkScrollableFrame(
            left, fg_color=_BG_LEFT, corner_radius=0,
        ...
        self._drop_zone = DropZone(
            scroll, on_file=self._on_file_selected,
        ...
        # ── Settings card ──────────────────────────────────────────────
        card = ctk.CTkFrame(scroll, corner_radius=10, fg_color=_BG_CARD,
                            border_width=1, border_color=_BORDER)
        card.grid(row=2, column=0, padx=12, pady=(4, 12), sticky="ew")
        ...
        # Start button (fixed at bottom of left panel)
        ...
        self._start_btn.grid(row=2, column=0, padx=12, pady=(8, 4), sticky="ew")

        self._progress_label = ctk.CTkLabel(
            left, text="", font=ctk.CTkFont(size=11),
            text_color=_TEXT_MUTED,
        )
        self._progress_label.grid(row=3, column=0, padx=16, sticky="w")
    ...
    def _build_right(self):
        ...
        self._export_btn = ctk.CTkButton(
            bar, text="エクスポート ▾", width=110, height=30, corner_radius=8,
            fg_color="#FFFFFF", text_color=_ACCENT,
            border_width=1, border_color=_BORDER,
            hover_color="#EFF6FF",
            command=self._show_export_menu, state="disabled",
        )
        self._export_btn.pack(side="right", padx=(4, 0))

        self._edit_toggle = EditToggle(bar, command=self._toggle_edit_mode, bg=_BG_RIGHT)
        self._edit_toggle.pack(side="right", padx=(4, 14))
        ...
        self._autosave_hint.pack(side="left")
    ...
    def _set_export_state(self, state: str):
        for btn in (self._export_btn, self._copy_btn,
                    self._edit_toggle, self._save_proj_btn):
